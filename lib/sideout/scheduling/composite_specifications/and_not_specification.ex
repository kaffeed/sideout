defmodule Sideout.Scheduling.CompositeSpecifications.AndNotSpecification do
  @moduledoc """
  Composite specification that is satisfied when left is satisfied AND right is NOT satisfied.
  ...
  ## Examples
      ...
      iex> spec = %AndNotSpecification{left: max_18, right: even}
  ...
  defimpl Specification do
    ...
    def description(%{left: left, right: right}) do
      "(#{Specification.description(left)} AND NOT (#{Specification.description(right)}))"
    end

    def name(_), do: "and_not"
