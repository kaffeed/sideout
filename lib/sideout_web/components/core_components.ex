defmodule SideoutWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: SideoutWeb.Gettext
        ...
        <div class="flex min-h-full items-center justify-center">
          <div class="w-full max-w-3xl p-4 sm:p-6 lg:py-8">
            <.focus_wrap
              ...
              class="shadow-neutral-700/10 dark:shadow-neutral-950/50 ring-neutral-700/10 dark:ring-neutral-600/20 relative hidden rounded-2xl bg-white dark:bg-secondary-800 p-14 shadow-lg dark:shadow-sporty-lg ring-1 transition"
            >
              <div class="absolute top-6 right-5">
                <button
                  phx-click={JS.exec("data-cancel", to: "##{@id}")}
                  type="button"
                  class="-m-3 flex-none p-3 opacity-20 hover:opacity-40 text-neutral-900 dark:text-neutral-100"
  ...
  def button(assigns) do
    ...
    <button
      type={@type}
      class={[
        "phx-submit-loading:opacity-75 rounded-lg bg-primary-500 hover:bg-primary-600 dark:bg-primary-600 dark:hover:bg-primary-500 py-2 px-3",
        "text-sm font-semibold leading-6 text-white active:text-white/80 shadow-md hover:shadow-sporty transition-all duration-200",
        @class
      ]}
      {@rest}
    >
  ...
  def input(%{type: "checkbox"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      <label class="flex items-center gap-4 text-sm leading-6 text-neutral-600 dark:text-neutral-300">
  ...
  def input(%{type: "select"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <select
        id={@id}
        name={@name}
        class="mt-2 block w-full rounded-md border border-neutral-300 dark:border-secondary-600 bg-white dark:bg-secondary-700 text-neutral-900 dark:text-neutral-100 shadow-sm focus:border-primary-500 focus:ring-primary-500 sm:text-sm"
        multiple={@multiple}
        {@rest}
      >
  ...
  def input(%{type: "textarea"} = assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <textarea
        ...
        name={@name}
        class={[
          "mt-2 block w-full rounded-lg bg-white dark:bg-secondary-700 text-neutral-900 dark:text-neutral-100 border-2 focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 sm:text-sm sm:leading-6",
          "min-h-[6rem] phx-no-feedback:border-neutral-300 dark:phx-no-feedback:border-secondary-600 phx-no-feedback:focus:border-primary-500",
          @errors == [] && "border-neutral-300 dark:border-secondary-600 focus:border-primary-500",
          @errors != [] && "border-danger-400 dark:border-danger-500 focus:border-danger-400"
        ]}
        {@rest}
  ...
  def input(assigns) do
    ...
    <div phx-feedback-for={@name}>
      ...
      <input
        ...
        class={[
          "mt-2 block w-full rounded-lg bg-white dark:bg-secondary-700 text-neutral-900 dark:text-neutral-100 border-2 focus:ring-2 focus:ring-primary-500 focus:ring-opacity-50 sm:text-sm sm:leading-6",
          "phx-no-feedback:border-neutral-300 dark:phx-no-feedback:border-secondary-600 phx-no-feedback:focus:border-primary-500",
          @errors == [] && "border-neutral-300 dark:border-secondary-600 focus:border-primary-500",
          @errors != [] && "border-danger-400 dark:border-danger-500 focus:border-danger-400"
        ]}
        {@rest}
          ...
          >
            ...
            <td :if={@action != []} class="relative w-14 p-0">
              <div class="relative whitespace-nowrap py-4 text-right text-sm font-medium">
                <span class="absolute -inset-y-px -right-4 left-0 group-hover:bg-neutral-50 dark:group-hover:bg-secondary-700/50 sm:rounded-r-xl" />
                <span
                  :for={action <- @action}
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SideoutWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SideoutWeb.Gettext, "errors", msg, opts)
    end
  end
