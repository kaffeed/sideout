        ...
        <div class="mt-8">
          <%= if @players == [] do %>
            <div class="text-center">
              ...
              <h3 class="mt-2 text-sm font-semibold text-neutral-900 dark:text-neutral-100">No players found</h3>
                          ...
                          <div class="flex items-center gap-2">
                            <span class={[
                              ...
                              if(player.stats.attendance_rate >= 80,
                                do: "bg-success-50 text-success-700 ring-1 ring-inset ring-success-600/20 dark:bg-success-900/30 dark:text-success-400 dark:ring-success-400/30",
                                else:
